...
(function () {
    ...
    /**
     * @param {Eyes} eyes
     * @param {EyesRemoteWebElement|webdriver.WebElement} element
     * @return {Promise<EyesRegionProvider>}
     */
    ...
    /**
     * @param {EyesRemoteWebElement|webdriver.WebElement} element
     * @return {Promise<{left: number, top: number, width: number, height: number}>} region
     */
